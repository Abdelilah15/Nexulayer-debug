...
export default function B20Form() {
  ...
  <div className="animate-in fade-in duration-500">
    ...
    >
      ...
      {isAdvancedMode && (
        <div className="bg-background border border-card rounded-lg sm:rounded-xl p-3 sm:p-4 flex flex-col sm:flex-row gap-3 sm:gap-6 mt-4 sm:mt-6">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-xs sm:text-sm font-medium text-foreground">Standard Asset</span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-xs sm:text-sm font-medium text-foreground">Stablecoin (6 Decimals)</span>
          </label>
        </div>
      )}
