  ...
  return (
    <header className="w-full bg-neutral-950 border-b border-neutral-800 px-6 py-4 flex justify-between items-center sticky top-0 z-50">
      <div className="flex items-center gap-3">
        ...
        <span className="text-xl font-bold text-white tracking-tight">Admin<span className="text-neutral-500">Panel</span></span>
      </div>

      {/* Bouton RainbowKit qui gère toute l'UI de connexion */}
      <ConnectButton />
    </header>
  );
}
