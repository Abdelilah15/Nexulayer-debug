    ...
    <>
      ...
      `}>
        ...
        <nav className={`flex-1 overflow-y-auto py-6 space-y-2 md:space-y-3 ${isCollapsed ? 'px-2' : 'px-4'}`}>
          ...
          <button onClick={() => navigateTo('/deploy/simple')} className={`cursor-pointer w-full flex items-center py-2.5 rounded-xl transition-all duration-200 ${isSimple ? 'bg-accent/10 text-accent' : 'text-secondary hover:bar-button-hover'} ${isCollapsed ? 'hidden md:flex justify-center px-0' : 'px-3 text-sm font-medium'}`}>
            <i className="fi fi-rr-document flex text-xl"></i>
            <span className={`ml-3 ${isCollapsed ? 'md:hidden' : 'block'}`}>Basic Contract</span>
          </button>

          <button onClick={() => navigateTo('/deploy/message')} className={`cursor-pointer w-full flex items-center py-2.5 rounded-xl transition-all duration-200 ${isMessage ? 'bg-accent/10 text-accent' : 'text-secondary hover:bar-button-hover'} ${isCollapsed ? 'hidden md:flex justify-center px-0' : 'px-3 text-sm font-medium'}`}>
            <i className="fi fi-rr-edit flex text-xl"></i>
            <span className={`ml-3 ${isCollapsed ? 'md:hidden' : 'block'}`}>On-Chain Message</span>
          </button>

          <button onClick={() => navigateTo('/deploy/erc20')} className={`cursor-pointer w-full flex items-center py-2.5 rounded-xl transition-all duration-200 ${isERC20 ? 'bg-accent/10 text-accent' : 'text-secondary hover:bar-button-hover'} ${isCollapsed ? 'hidden md:flex justify-center px-0' : 'px-3 text-sm font-medium'}`}>
            <i className="fi fi-rr-coins flex text-xl"></i>
            <span className={`ml-3 ${isCollapsed ? 'md:hidden' : 'block'}`}>ERC-20 Token</span>
          </button>

          <button onClick={() => navigateTo('/deploy/b20')} className={`cursor-pointer w-full flex items-center py-2.5 rounded-xl transition-all duration-200 ${isB20 ? 'bg-accent/10 text-accent' : 'text-secondary hover:bar-button-hover'} ${isCollapsed ? 'hidden md:flex justify-center px-0' : 'px-3 text-sm font-medium'}`}>
            <i className="fi fi-rr-bolt flex text-xl"></i>
            <span className={`ml-3 ${isCollapsed ? 'md:hidden' : 'block'}`}>B20 Asset (Base)</span>
          </button>

          <button onClick={() => navigateTo('/deploy/erc721')} className={`cursor-pointer w-full flex items-center py-2.5 rounded-xl transition-all duration-200 ${isERC721 ? 'bg-accent/10 text-accent' : 'text-secondary hover:bar-button-hover'} ${isCollapsed ? 'hidden md:flex justify-center px-0' : 'px-3 text-sm font-medium'}`}>
            <i className="fi fi-rr-picture flex text-xl"></i>
            <span className={`ml-3 ${isCollapsed ? 'md:hidden' : 'block'}`}>NFT Collection</span>
          </button>

          <button onClick={() => navigateTo('/deploy/erc1155')} className={`cursor-pointer w-full flex items-center py-2.5 rounded-xl transition-all duration-200 ${isERC1155 ? 'bg-accent/10 text-accent' : 'text-secondary hover:bar-button-hover'} ${isCollapsed ? 'hidden md:flex justify-center px-0' : 'px-3 text-sm font-medium'}`}>
