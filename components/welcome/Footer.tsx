...
import Forgenix, { NexulayerLogo, NexulayerText } from "@/components/ui/NexulayerLogo";

export default function Footer() {
    return (
        // ← sm:min-h-screen : le plein écran reste uniquement sur tablette/desktop
                ...
                <div className="overflow-hidden rounded-3xl bg-white shadow-[0_30px_100px_rgba(0,82,255,0.08)] sm:rounded-[42px]">
                    ...
                    <div className="border-b border-slate-100 px-4 pb-5 pt-6 sm:px-10 sm:pb-10 sm:pt-16 lg:px-20 lg:pt-20">
                        <div className="max-w-4xl">
                            ...
                            {/* ← text-2xl sur mobile, inchangé ensuite */}
                            ...
                            {/* ← marges et taille réduites sur mobile */}
                    ...
                    {/* ================= LINKS ================= */}
                    {/*
                        Mobile  : grid-cols-2 → Product | Contracts côte à côte
                        sm      : sm:grid-cols-1 → reset 1 colonne (comportement original tablette)
                        md      : md:grid-cols-2 → inchangé
                        lg      : lg:grid-cols-4 → inchangé
                    */}
                    <div className="grid grid-cols-2 gap-x-4 gap-y-7 px-4 py-6 sm:grid-cols-1 sm:gap-14 sm:px-10 sm:py-16 md:grid-cols-2 lg:grid-cols-4 lg:px-20">
                        ...
                        {/*
                            Community
                            ← col-span-2 sur mobile (pleine largeur sous les 2 colonnes)
                            ← sm:col-span-1 : comportement normal sur sm+
                        */}
                        <div className="col-span-2 sm:col-span-1">

                            {/* Titre masqué sur mobile (les icônes parlent d'elles-mêmes) */}
                            <h3 className="mb-5 hidden text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 sm:mb-6 sm:block">
                                Community
                            </h3>

                            {/* ── MOBILE : icônes uniquement, côte à côte ── */}
                            <div className="flex flex-wrap items-center gap-5 sm:hidden">

                                {/* Discord — désactivé */}
                                <span className="cursor-not-allowed text-slate-400 opacity-50" title="Bientôt disponible">
                                ...
                                {/* X (Twitter) — actif */}
                                <Link href="#" className="text-slate-700 transition-colors hover:text-[#0052FF]">
                            ...
                            {/* ── sm+ : liste verticale icône + texte (inchangée) ── */}
                    ...
                    {/* ================= BOTTOM ================= */}
                    {/* ← padding et gap réduits sur mobile */}
