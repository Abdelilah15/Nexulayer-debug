    ...
    return (
        <div className="space-y-3">
            <div className="flex flex-col sm:flex-row gap-3">
                <div>
                    <button onClick={() => setSelectedAsset('Tokens')} className={`border border-slate-700 rounded-l-lg px-3 py-2 text-sm focus:outline-none ${selectedAsset === 'Tokens' ? "bg-slate-800 text-white" : "bg-slate-900 text-slate-400"}`}>Tokens</button>
                    <button onClick={() => setSelectedAsset('DeFi')} className={`border border-slate-700 px-3 py-2 text-sm focus:outline-none ${selectedAsset === 'DeFi' ? "bg-slate-800 text-white" : "bg-slate-900 text-slate-400"}`}>DeFi</button>
                    <button onClick={() => setSelectedAsset('NFTs')} className={`border border-slate-700 rounded-r-lg px-3 py-2 text-sm focus:outline-none ${selectedAsset === 'NFTs' ? "bg-slate-800 text-white" : "bg-slate-900 text-slate-400"}`}>NFTs</button>
                </div>
                <input
                    type="text"
